// Thêm Loader2 từ lucide-react và Swal từ sweetalert2
...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Đảm bảo URL này đúng với backend đã sửa của bạn
      const apiUrl = `http://localhost:7081/picon/mail/contact`; // <-- URL có /contact
